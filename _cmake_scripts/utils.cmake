...
macro( modules )
	...
	foreach (module ${${SOLUTION_NAME}_modules})
		...
		print_compile_status("Setting variables for ${module}")
		print_compile_status("  - directory: ${${module}_INCLUDE_DIRS}")
		print_compile_status("  - library: ${${module}_LIBRARIES}")
	endforeach( module )
endmacro( modules )
...
macro( compile_tests )
	...
	foreach (module ${${SOLUTION_NAME}_modules} )
		print_compile_status("Compiling tests for ${module} module.")
		set( module_name ${module} )
		set( tests_name ${module}_tests )
		add_subdirectory( ${tests_name} )
	endforeach( module )
	foreach (dll ${${SOLUTION_NAME}_dlls} )
		print_compile_status("Compiling tests for ${module} dll.")
		set( module_name ${dll} )
...
macro( compile_project project_name source_pattern header_pattern build_type solution_folder )
	...
	print_compile_status("* Creating project: ${project_name}(${build_type}) with '${solution_folder}' (${PROJECT_SOURCE_DIR}) from: ${source_pattern}, ${header_pattern}.")
	...
	foreach( dependencie ${ARGN} )
		print_compile_status("   - Adding thread dependencie: '${${dependencie}_INCLUDE_DIRS}'")
	...
	if (NOT "${build_type}" STREQUAL "STATIC")
		foreach( dependencie ${ARGN} )
			...
			print_compile_status("   - Adding library dependencie: ${${dependencie}_LIBRARIES}")
		endforeach( dependencie )	
	endif()
